from Config.CFG_Shop.cfg_shop_type import inventory_shop, update_resources, update_ship, ginetic_lab, \
    repository, ship_factory
from Inventory.PlanetInventory import PlanetInventory
from Static.Type.SpaceObject.T_Shop import T_Shop


class Shop:

    def __init__(self, data, Planet):
        # self.
        self.type_ = list()
        id_ = data['id']
